...
<?php 
    ...
    if (isset($_FILES['fichier']) && $_FILES['fichier']['error'] == 0) {
        // Vérifier si la taille du fichier reçu est inférieur à 10Mo
        if ($_FILES['fichier']['size'] <= 10000000) {
            // Créer un tableau pour stocker les extensions de fichier autorisée
            ...
            // Je récupère l'extension du fichier qui a été récupérer
            ...
            if (in_array($extensionImage,$extensionArray)) {
                ...
                header('location: ../../src/pages/articles?choix=uploaderPhoto&error=true&message=extension non autorisée. Fait pas le malin !');
                exit();
            }
        }
    }
